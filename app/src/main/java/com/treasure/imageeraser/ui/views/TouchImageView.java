...
public class TouchImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    static class C03231 {
        static final int[] scaleTypes;

        static {
            scaleTypes = new int[ScaleType.values().length];
            try {
                scaleTypes[ScaleType.CENTER.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                scaleTypes[ScaleType.CENTER_CROP.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                scaleTypes[ScaleType.CENTER_INSIDE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                scaleTypes[ScaleType.FIT_CENTER.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                scaleTypes[ScaleType.FIT_XY.ordinal()] = 5;
    ...
    private void fitImageToView() {
        ...
        if (drawable != null && drawable.getIntrinsicWidth() != 0 && drawable.getIntrinsicHeight() != 0 && this.matrix != null && this.prevMatrix != null) {
            ...
            switch (C03231.scaleTypes[this.mScaleType.ordinal()]) {
                case 1 /*1*/:
...
////        || this.state == State.DRAG || this.state == State.FLING || this.state == State.ZOOM
